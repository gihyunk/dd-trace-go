...
import (
	...
	grpctrace "github.com/gihyunk/dd-trace-go.v1/contrib/google.golang.org/grpc"
	httptrace "github.com/gihyunk/dd-trace-go.v1/contrib/julienschmidt/httprouter"
