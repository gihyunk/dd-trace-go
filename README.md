...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/gihyunk/dd-trace-go/ddtrace)
...
```bash
go get github.com/gihyunk/dd-trace-go/ddtrace/tracer
go get github.com/gihyunk/dd-trace-go/profiler
```

Additionally there are many [contrib](./contrib) packages that can be installed as needed like this:

```
go get github.com/gihyunk/dd-trace-go/contrib/gorilla/mux
```
...
### Documentation
 ...
 - [API](https://pkg.go.dev/github.com/gihyunk/dd-trace-go/ddtrace)
